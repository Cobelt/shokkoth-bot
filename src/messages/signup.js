...
export function shouldRemoveMsg({ client, message, args } = {}) {
    const embed = new Discord.MessageEmbed()
        .setColor('#0099ff')
        .setTitle(
            'Pense à bien supprimer le message de ta commande $signup pour que des yeux baladeurs ne te volent pas ton mot de passe !'
        )
...
export function wrongFormat({ client, message, args } = {}) {
    const embed = new Discord.MessageEmbed()
        ...
        .setDescription('$signup [username] [password]')
